...
DATABASES = {
    'default': {
        ...
        'NAME': getenv("DJANGO_POSTGRES_DB"),
        'USER': getenv("DJANGO_POSTGRES_USER"),
        'PASSWORD': getenv("DJANGO_POSTGRES_PASSWORD"),
        'HOST': getenv("DJANGO_POSTGRES_HOST"), #'localhost'
        'PORT': getenv("DJANGO_POSTGRES_PORT"),
    }
}
